...
const ProjectCard = ({ title, main, img , showDemoButton, demoLink, sourceLink }) => {
  return (
    <div className='p-3 md:p-6 flex flex-col w-80 bg-[#0c0e19] shadow-slate-900 rounded-2xl'>
        <img className="p-4 h-48 object-contain" src={img} alt={title} />
        ...
        <div className='flex justify-center mt-2 p-2 md:p-4 flex gap-2 md:gap-4'>
            {showDemoButton && (
